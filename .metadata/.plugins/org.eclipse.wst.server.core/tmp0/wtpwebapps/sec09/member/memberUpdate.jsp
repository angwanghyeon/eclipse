...
<body>
	...
	<form name="frm" id="reg_frm" method="post"
		...
		readonly="readonly" size="20" value="${loginUser.userid}"><br>
		...
		<label for="admin">등급</label><span style="color:red;" > * </span>
		 <input type="radio"
			name="admin"  value="0"  ${loginUser.admin == 0 ? "checked" : ""}>일반회원
		<input type="radio"
			name="admin"  value="1"  ${loginUser.admin == 1 ? "checked" : ""}>관리자<br>
